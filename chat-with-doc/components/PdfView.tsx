...
// gsutil cors set cors.json gs://chat-with-doc-db.appspot.com
// no here >>> https://console.cloud.google.com/
// create new file in editor calls cors.json
// run >>> // gsutil cors set cors.json gs://chat-with-doc-db.appspot.com
